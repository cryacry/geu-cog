...
func TestBaseImageName(t *testing.T) {
	for _, tt := range []struct {
		...
		{"", "3.8", "",
			"r8.im/geu_cog-base:python3.8"},
		{"", "3.8", "2.1",
			"r8.im/geu_cog-base:python3.8-torch2.1.2"},
		{"12.1", "3.8", "",
			"r8.im/geu_cog-base:cuda12.1-python3.8"},
		{"12.1", "3.8", "2.1",
			"r8.im/geu_cog-base:cuda12.1-python3.8-torch2.1.2"},
		{"12.1", "3.8", "2.1",
			"r8.im/geu_cog-base:cuda12.1-python3.8-torch2.1.2"},
	} {
...
func TestBaseImageNameWithVersionModifier(t *testing.T) {
	...
	require.Equal(t, "r8.im/geu_cog-base:cuda12.1-python3.8-torch2.0.1", actual)
}
